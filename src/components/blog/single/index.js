...
import SingleBlogPostHeader from "./header"
...
const BlogSingle = () => {
  return (
    <Layout>
      <article>
        <SingleBlogPostHeader />
        <section>
          <div className="flex md:flex-row flex-col">
            <div className="w-2/12 min-w-[223px]">
              <SharePost />
            </div>
            <div className="md:pt-[120px] md:pl-[40px] md:pr-0 pr-5 pl-5 pt-16 md:w-8/12">
              <p>
